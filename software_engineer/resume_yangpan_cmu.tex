...
\item Work including \textit{mobile app development(Cocoa and Foundation framework), server program development, C/S network communication, cocos2d engine, web development}
\end{rSubsection}

%------------------------------------------------

\begin{rSubsection}{Project: Beautiful Life, an online iOS game}{\em Dec. 2011 - May 2012}{}{}
...
\item AppStore link to this project and more projects I participated in are available in my LinkedIn (ysite.me)
\end{rSubsection}
